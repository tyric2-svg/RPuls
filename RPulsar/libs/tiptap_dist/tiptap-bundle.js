var TiptapBundle = (function (exports) {
  'use strict';
...
3. "-" cannot repeat`);
  ...
  */
  ...
  const TiptapStarterKit = index_default$1;
  const TiptapPlaceholder = index_default;

  // Инициализация глобального объекта для браузерного использования
  if (typeof window !== 'undefined') {
    window.TiptapBundle = {
      Editor: Editor,
      StarterKit: index_default$1,
    ...
    console.log('- StarterKit:', typeof index_default$1);
    console.log('- Placeholder:', typeof index_default);
  }

  exports.TiptapEditor = TiptapEditor;
  exports.TiptapPlaceholder = TiptapPlaceholder;
  exports.TiptapStarterKit = TiptapStarterKit;
